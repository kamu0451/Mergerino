    ...
    , interaction_(this)
{
    ...
    this->setWindowTitle(u"Mergerino - Overlay"_s);
...
void OverlayWindow::triggerFirstActivation()
{
    ...
    if (actualShortcut.isEmpty())
    {
        welcomeText +=
            ...
            "category to press while any Mergerino window is focused."_s;
    }
    else
    {
        welcomeText +=
            u"To toggle the click-through mode, press %1 (customizable "_s
            "in the settings) while any Mergerino window is focused.".arg(
    ...
    {
        welcomeText +=
            u" Please provide feedback <a href=\"%1\">on GitHub</a>."_s.arg(
                LINK_MERGERINO_SOURCE.toString());
    }

    auto *box =
        new QMessageBox(QMessageBox::Information, u"Mergerino - Overlay"_s,
