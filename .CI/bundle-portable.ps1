...
if ($isTagged) {
    ...
    $bundleBaseName = "Mergerino.Portable";
}
else {
    Write-Output nightly | Out-File Chatterino2/modes -Append -Encoding ASCII;
    $bundleBaseName = "Mergerino.Nightly.Portable";
}
...
Move-Item c2-portable-updater.exe "Chatterino2/updater.1/MergerinoUpdater.exe" -Force;
