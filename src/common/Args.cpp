...
Args::Args(const QApplication &app, const Paths &paths)
{
    ...
    parser.setApplicationDescription(
        "Mergerino streamer chat client for Twitch, Kick, and YouTube");
    ...
    QCommandLineOption loginOption(
        "login",
        "Starts Mergerino logged in as the account matching the supplied "
        "username. If the supplied username does not match any account "
        "Mergerino starts logged in as anonymous.",
        "username");
    ...
    QCommandLineOption useOldScalingOption(
        "use-old-scaling",
        "Starts Mergerino with the old scaling option applied. This is not a "
