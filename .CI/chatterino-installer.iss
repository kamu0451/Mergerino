...
#define MyAppName "Mergerino"
#define MyAppVersion "7.5.5"
#define MyAppPublisher "Mergerino"
#define MyAppURL ""
#define MyAppExeName "mergerino.exe"
...
#else
OutputBaseFilename=Mergerino.Installer
#endif
Compression=lzma
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "Mergerino.Mergerino"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "Mergerino.Mergerino"; Tasks: desktopicon
...
Type: filesandordirs; Name: "{userappdata}\Mergerino\Cache"
; Delete %appdata%\Mergerino on freshinstall
Type: filesandordirs; Name: "{userappdata}\Mergerino"; Tasks: freshinstall
