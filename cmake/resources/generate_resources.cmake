...
set(KICK_ONBOARDING_IMAGE_FILES
        kick_onboarding/client-credentials.png
        kick_onboarding/create-app.png
        kick_onboarding/redirect-url.png
        kick_onboarding/scopes-requested.png
)
set(
        RES_IGNORED_FILES
        .gitignore
        ...
        ${KICK_ONBOARDING_IMAGE_FILES}
        themes/ChatterinoTheme.schema.json
)
set(RES_EXCLUDE_FILTER ^raw)
set(RES_IMAGE_EXCLUDE_FILTER "^(buttons/(update|clearSearch)|avatars|icon|settings|raw|kick_onboarding)")
...
endforeach ()
if (EXISTS "${CMAKE_SOURCE_DIR}/patchnotes.txt")
    list(APPEND RES_RESOURCES_CONTENT "    <file alias=\"patchnotes.txt\">${CMAKE_SOURCE_DIR}/patchnotes.txt</file>")
    file(MAKE_DIRECTORY "${CMAKE_BINARY_DIR}/bin")
    configure_file("${CMAKE_SOURCE_DIR}/patchnotes.txt" "${CMAKE_BINARY_DIR}/bin/patchnotes.txt" COPYONLY)
endif ()
file(MAKE_DIRECTORY "${CMAKE_BINARY_DIR}/bin/kick_onboarding")
foreach (_file ${KICK_ONBOARDING_IMAGE_FILES})
    get_filename_component(_name "${_file}" NAME)
    configure_file("${RES_DIR}/${_file}" "${CMAKE_BINARY_DIR}/bin/kick_onboarding/${_name}" COPYONLY)
    list(APPEND KICK_ONBOARDING_IMAGE_PATHS "${RES_DIR}/${_file}")
endforeach ()
if (BUILD_APP)
    install(FILES
            ${KICK_ONBOARDING_IMAGE_PATHS}
            DESTINATION kick_onboarding
